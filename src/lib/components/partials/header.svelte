		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 align-center">
				...
				<div class="kf-h-social">
					<a href="facebook.com" target="blank"><i class="fab fa-facebook-f" /></a>
					<a href="twitter.com" target="blank"><i class="fab fa-twitter" /></a>
					<a href="instagram.com" target="blank"><i class="fab fa-instagram" /></a>
					<a href="youtube.com" target="blank"><i class="fab fa-youtube" /></a>
				</div>
			</div>
		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 align-center">
				...
				<div class="kf-main-menu">
					<ul>
						<li>
							<a href="/">Home<i class="las la-angle-down" /></a>
							<ul>
						...
						<li>
							<a href="menu-coffee.html">Menu<i class="las la-angle-down" /></a>
							<ul>
